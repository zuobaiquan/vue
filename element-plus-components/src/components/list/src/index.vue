    ...
    <el-tabs>
      ...
      >
        <el-scrollbar max-height="200px">
          ...
          <div class="actions">
            <div class="a-item" :class="{'border': i !== actions.length }" v-for="(action, i) in actions" :key="i" @click="clickAction(action, i)">
...
import { ActionOptions, ListOptions, IListItem } from "./types"
...
let clickItem = (item:IListItem, index:number) => {
